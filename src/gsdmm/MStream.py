from src.gsdmm import DocumentSet
from src.gsdmm import Model

class MStream:
    dataDir = r"C:\Users\JS\PycharmProjects\SEERa\data/"
    ...
    def getDocuments(self):
        self.documentSet = DocumentSet.DocumentSet(self.dataDir + self.dataset, self.wordToIdMap, self.wordList)
    ...
    def runMStream(self, sampleNo, outputPath):
        ...
        model = Model.Model(self.K, self.MaxBatch, self.V, self.iterNum, self.alpha, self.beta, self.dataset,
