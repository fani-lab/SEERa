...
def topic_modeling(processed_docs, num_topics=20, filterExtremes=False, library='gensim', path_2_save_tml='../../output/tml'):
    ...
    if library == 'gensim':
        ...
        lda_model = gensim.models.wrappers.LdaMallet(mallet_path, corpus=bow_corpus, num_topics=num_topics, id2word=dictionary)
